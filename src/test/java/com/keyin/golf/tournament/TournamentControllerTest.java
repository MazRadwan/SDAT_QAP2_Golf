...
public class TournamentControllerTest {
    ...
    public void getTournament_ShouldReturnTournament() throws Exception {
        ...
        mockMvc.perform(get("/api/tournaments/1"))
                ...
                .andExpect(jsonPath("$.location").value("Pine Valley"));
    }
    ...
    public void searchByDate_ShouldReturnMatchingTournaments() throws Exception {
        ...
        mockMvc.perform(get("/api/tournaments/search/date")
                        .param("startDate", "2024-01-15"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].location").value("Pine Valley"));
    }
    ...
    public void searchByDateRange_ShouldReturnMatchingTournaments() throws Exception {
        ...
        mockMvc.perform(get("/api/tournaments/search/dateRange")
