...
public class MemberServiceTest {
    ...
    public void searchByName_ShouldReturnMatchingMembers() {
        ...
        member1.setMemberName("John Doe");
        Member member2 = new Member();
        member2.setMemberName("Johnny Smith");

        when(memberRepository.findByMemberNameContainingIgnoreCase("John"))
        ...
        assertTrue(results.stream().anyMatch(m -> m.getMemberName().equals("Johnny Smith")));
        verify(memberRepository).findByMemberNameContainingIgnoreCase("John");
    }
