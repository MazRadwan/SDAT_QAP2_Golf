...
public class MemberRepositoryTest {
    ...
    @Test
    public void findByMemberNameContainingIgnoreCase_ShouldReturnMember() {
        // Create test member
        ...
        // Test search
        List<Member> found = memberRepository.findByMemberNameContainingIgnoreCase("john");
    ...
    @Test
    public void findByMemberNameContainingIgnoreCase_ShouldReturnEmpty() {
        List<Member> found = memberRepository.findByMemberNameContainingIgnoreCase("NonExistent");
        assertThat(found).isEmpty();
    }

    @Test
    public void findByMemberNameContainingIgnoreCase_ShouldBeCaseInsensitive() {
        Member member = new Member();
        member.setMemberName("John Doe");
        member.setMemberEmail("john@example.com");
        member.setStartDate(LocalDate.of(2024, 1, 1));
        ...
        List<Member> foundLower = memberRepository.findByMemberNameContainingIgnoreCase("john");
        List<Member> foundUpper = memberRepository.findByMemberNameContainingIgnoreCase("JOHN");
        List<Member> foundMixed = memberRepository.findByMemberNameContainingIgnoreCase("JoHn");
